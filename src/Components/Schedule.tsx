...
//! Again this function may not be needed in typescript, but I am leaving it in for now.
    function parseBoolean(friendly: boolean) {
        if (friendly === true) {
            return true;
        } else {
            return false;
        ...
        <div className='row m-3 centerContent'>
            ...
            <div className='col title2'>
                ...
                {sortedUsers.map((user) => (
                    ...
                    <div className='card m-3 shadow border border-1 border-secondary rounded-3' key={user.id}>
