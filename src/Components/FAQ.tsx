  ...
  return (
    ...
    <div className='container-fluid'>
        ...
        <h5><ul>
            ...
            <li className='list-unstyled'>A. Hi! I'm Michael and I live here too! The reason I made this was for a project to showcase my skills as a front end software developer. It was too good not to share and only costs me a small amount to upkeep.</li>
            <br/>
            <li className='fw-bolder'>Q. Why can't I make an account? I want to save stuff!</li>
            <li className='list-unstyled'>A. I felt part of the charm of doing things this way is that you can stay as annonymous as you want. You don't have to put your real name, although it works best if that is the only part not real. It's not nice to call a dog by the wrong name, and in canine circles it could be considered insulting.</li>
            <br/>
            <li className='fw-bolder'>Q. How can I get in touch with you?</li>
            <li className='list-unstyled'>A.The preferred method of contact for me is my email, which is michaelvarnell@icloud.com</li>
            </ul><br/>
